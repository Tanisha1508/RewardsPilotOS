...
> Answering uses Google Gemini. Your question, the cards and balances you have
> recorded, and your preferences are sent there; account identifiers are removed
> first. Answers are saved to your History until you delete them.
...
contents and does not editorialise about safety. It mentions identifier
stripping (P2) because that is the one mitigation a reader cannot verify for
themselves.
